...
public class HelldiversModParticleTypes {
	...
	public static final RegistryObject<SimpleParticleType> BLUE_BEAM = REGISTRY.register("blue_beam", () -> new SimpleParticleType(true));
	...
	public static final RegistryObject<SimpleParticleType> GAS = REGISTRY.register("gas", () -> new SimpleParticleType(false));
}
