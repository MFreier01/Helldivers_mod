...
public class CallOrbitalGasStrikeProcedure {
				...
				if (world instanceof ServerLevel projectileLevel) {
					Projectile _entityToSpawn = new Object() {
						public Projectile getArrow(Level level, float damage, int knockback) {
							AbstractArrow entityToSpawn = new GasStrikeProjectileEntity(HelldiversModEntities.GAS_STRIKE_PROJECTILE.get(), level);
					...
					_entityToSpawn.shoot(0, (-1), 0, 10, 3);
