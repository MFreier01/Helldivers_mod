...
import net.hytech.helldivers.item.model.HeavyFS23RemoteModel;
import net.hytech.helldivers.item.HeavyFS23RemoteItem;

public class HeavyFS23RemoteArmorRenderer extends GeoArmorRenderer<HeavyFS23RemoteItem> {
	public HeavyFS23RemoteArmorRenderer() {
		super(new HeavyFS23RemoteModel());
	...
	@Override
	public RenderType getRenderType(HeavyFS23RemoteItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
