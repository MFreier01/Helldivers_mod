...
import net.hytech.helldivers.item.model.BasicarmorModel;
import net.hytech.helldivers.item.BasicarmorItem;

public class BasicarmorArmorRenderer extends GeoArmorRenderer<BasicarmorItem> {
	public BasicarmorArmorRenderer() {
	...
	@Override
	public RenderType getRenderType(BasicarmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
