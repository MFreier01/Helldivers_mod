...
public class AmmoboxguiScreen extends AbstractContainerScreen<AmmoboxguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("helldivers:textures/screens/ammoboxgui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.helldivers.ammoboxgui.label_ammo_box"), 7, 4, -12829636, false);
	}
