...
public class GasParticle extends TextureSheetParticle {
	public static GasParticleProvider provider(SpriteSet spriteSet) {
		return new GasParticleProvider(spriteSet);
	}
	...
	public static class GasParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new GasParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
	...
	protected GasParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		...
		this.quadSize *= 3f;
		this.lifetime = (int) Math.max(1, 160 + (this.random.nextInt(300) - 150));
		this.gravity = 0f;
